  ...
  const fetchEarthquakes = async () => {
    ...
    try {
      const response = await base44.integrations.Core.InvokeLLM({
        prompt: `Extrae los últimos 10 sismos de Chile desde el sitio web https://sismologia.cl/. 
        Para cada sismo devuelve: fecha_hora (string en formato DD/MM/YYYY HH:mm), lugar (string), profundidad (número en km), magnitud (número), url_detalle (string).
